# -*- coding: utf-8 -*-
#
# Distributed Systems documentation build configuration file, created by
...
htmlhelp_basename = 'DistributedSystemsdoc'
...
texinfo_documents = [
  ('index', 'DistributedSystems', u'Distributed Systems Documentation',
   u'George K. Thiruvathukal', 'DistributedSystems', 'One line description of project.',
   'Miscellaneous'),
]
